<?php
// tests/Feature/Ai/YdSpecCompileCommandTest.php
...
class YdSpecCompileCommandTest extends TestCase
{
    ...
    public function testCompileCommandProducesStage(): void
    {
        ...
        $this->assertStringContainsString('编译完成', $output);
